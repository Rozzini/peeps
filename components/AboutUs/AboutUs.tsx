export default function Who() {
  return (
    <section id="who" className="font-sans">
    <div className="container px-[1rem] sm:px-[4rem] sm:mx-auto">
        ...
        <div className="flex flex-col justify-center flex-1 px-6 py-12 ">
          ...
          <div className="mt-[1rem]">
           <ul className="list-disc list-outside">
              ...
              <li className="text-lg">EXCLUSIVE ACCESS TO THE 3D PEEP</li>
              <li className="text-lg">WHITELISTS FOR FUTURE DROPS</li>
              <li className="text-lg">EXCLUSIVE METAVERSE ACCESS</li>
              <li className="text-lg">EXCLUSIVE AND EARLY ACESS TO PARTNERSHIP OFFERS</li>
              <li className="text-lg">PLAY TO EARN</li>
            </ul>
          </div>
          ...
          <div className="mt-[1rem]">
            ...
            <ul className="list-disc">
              ...
              <li className="text-lg italic"><strong>30 Apogees </strong>are uniquely made and only exist once. Their appearance stands out as each
                one tells a unique story.</li>
              <li className="text-lg italic"><strong>10 Nomads </strong>are individually made and based on unique artists and their signature art work.
                Our project will collaborate with such talent to spread awareness amongst our community
                and theirs.</li>
              <li className="text-lg italic"><strong>9 Corpos </strong>are single editions made for the team and partners (no other NFTs will be held by
                the core team).</li>
              <li className="text-lg italic"><strong>1 Zero </strong>is the ultimate NFT to the entire collection which holds secret powers that will
            ...
            <p className="my-6 dark:text-gray-400 text-lg">
              ...
              our peeps community, we make sure to further incentivize our members through passive
              income structures, limited edition merchandise and exclusive access to partnerships,
