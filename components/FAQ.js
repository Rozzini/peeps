...
const Item = ({ title, children }) => {
	...
	return (
		<div className="border-gradient-br-indigo-purple-pink-gray-900 border-transparent border-solid border-2 rounded-xl ">
			...
			>
				<p className="lg:text-lg md:text-sm sm:text-xs font-medium">{title}</p>
...
export const FAQ = () => {
	return (
		<section id="faq">
			<div className="pl-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
				...
				<div class="grid overflow-hidden grid-cols-12 grid-rows-1 gap-2">
					<div className="box col-start-1 col-end-7">
					...
					<div className="box col-start-8 col-end-12">
				...
				<div class="grid overflow-hidden grid-cols-12 grid-rows-1 gap-2">
					<div className="box row-start-3 col-start-1 col-end-7">
					...
					<div className="box row-start-3 col-start-8 col-end-12">
