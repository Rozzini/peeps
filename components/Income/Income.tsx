export default function Income() {
    return (
      <div id="who" className="container px-[1rem] sm:px-[4rem] sm:mx-auto">
        ...
        <div className="flex flex-col overflow-hidden rounded-md shadow-sm md:flex-row-reverse">
          <div className="flex flex-col justify-center flex-1 px-6 py-12 ">
            ...
            <div className="flex flex-row items-center ">
              <div>
                <p className="section-category text-grey text-5xl font-barcade  text-transparent bg-clip-text bg-gradient-to-r from-indigo-500  via-purple-500 to-pink-500">
            ...
            <div className="mt-[1rem] font-sans">
             ...
             <ul className="list-disc text-gray-400">
                ...
                <li className="text-lg italic leading-8">9.4K will be offered for sale through a <strong>3 tier whitelist pool structure</strong>.</li>
                <li className="text-lg italic leading-8">
                     60% of the total one time sales (not resale) will be kept in our vault and Polkadot
                    (DOT) will be staked for APY (14% staking rewards) which go to the AnonymousPeeps holder!
                </li>
                <li className="text-lg italic leading-8">
                    5% of the continuous AnonymousPeeps royalties will go to ALL of our holders (starting
                    after sellout).
                </li>
              </ul>
            </div>
            <br />
            <div className="flex flex-row items-center ">
                <p className="section-category text-grey text-xl font-bold underline">
                    3 Tier Pool Structure
                </p>
            </div>
